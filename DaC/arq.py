...
with Diagram("Arq AWS", show=False, direction="BT", 
             graph_attr={"splines": "ortho", "nodesep": "0.25", "ranksep": "3"}):
    ...
    internet = Custom("", "./internet.jpg", width="2", height="2", imagescale="true", fixedsize="true")
        ...
        with Cluster("VPC"):
            ...
            with Cluster("Zona de Disponibilidade 1d"):
                ...
                with Cluster("Sub-rede Privada"):
                    ...
                    bd = Custom("", "./bd.png", width="1", height="1", imagescale="true", fixedsize="true")
                    filler = Blank("", width="0.01", height="0.1")
